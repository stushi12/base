...
impl Metrics {
    ...
    pub fn zero() {
        ...
        Self::engine_task_failure(Self::INSERT_TASK_LABEL).absolute(0);
        Self::engine_task_failure(Self::CONSOLIDATE_TASK_LABEL).absolute(0);
        Self::engine_task_failure(Self::BUILD_TASK_LABEL).absolute(0);
        Self::engine_task_failure(Self::FINALIZE_TASK_LABEL).absolute(0);
        Self::engine_task_failure(Self::SEAL_TASK_LABEL).absolute(0);
        Self::engine_task_failure(Self::GET_PAYLOAD_TASK_LABEL).absolute(0);
