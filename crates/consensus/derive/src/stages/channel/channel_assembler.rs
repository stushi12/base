    ...
    P: NextFrameProvider + OriginAdvancer + OriginProvider + SignalReceiver + Send + Debug,
{
    async fn next_data(&mut self) -> PipelineResult<Option<Bytes>> {
        ...
        #[cfg(feature = "metrics")]
        {
            ...
            crate::Metrics::pipeline_channel_buffer().set(count);
        }
        ...
        if let Some(channel) = self.channel.as_mut() {
            ...
            #[cfg(feature = "metrics")]
            {
                ...
                crate::Metrics::pipeline_channel_timeout().set(margin);
            }
            ...
            #[cfg(feature = "metrics")]
            {
                ...
                crate::Metrics::pipeline_channel_mem().set(size);
            }
            ...
            crate::Metrics::pipeline_max_rlp_bytes().set(max_rlp_bytes_per_channel as f64);
        ...
        crate::Metrics::pipeline_channel_mem().set(0);
